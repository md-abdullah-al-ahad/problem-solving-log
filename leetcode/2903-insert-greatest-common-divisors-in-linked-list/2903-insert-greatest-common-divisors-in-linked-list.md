<h1>2903 - Insert Greatest Common Divisors in Linked List</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/insert-greatest-common-divisors-in-linked-list/">insert-greatest-common-divisors-in-linked-list</a></h2><p>Given the head of a linked list <code>head</code>, in which each node contains an integer value.</p>
